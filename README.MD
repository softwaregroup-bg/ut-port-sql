...
The SQL port has a special method `updateSchema`, which updates all database object. It matches database objects to files in the file system and updates the database objects if differences are detected.
